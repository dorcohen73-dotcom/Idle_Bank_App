...
const sharedGameGlobals = [
    ...
    'NotificationQueue',
    'CustomerFlowController', 'GAME_CONFIG', 'GuardController', 'IdleBankGame', 'MissionController', 'PrestigeController', 'ShopController', 'SaveManager',
    ...
    'getClientSVG', 'handleMissionRedirect', 'handlePurchaseFeedback',
    'initCoinPool', 'initSound',
    'reportCrash',
    ...
    'triggerPrestigeCeremony', 'triggerVipVisitBanner',
