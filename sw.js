const CACHE_NAME = 'idle-bank-v1.3.0';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=20260626_2',
  './config.js',
  './audio.js',
  './locales.js?v=20260626_2',
  './economy-manager.js?v=20260626_2',
  './save-manager.js?v=20260626_2',
  './mission-controller.js?v=20260626_2',
  './game.js?v=20260626_2',
  './ui-draw.js?v=20260626_2',
  './ui-tabs.js?v=20260626_2',
  './ui-events.js?v=20260626_2',
  './app.js?v=20260626_2',
  './privacy.html',
  './תמונות/icon.png',
  './תמונות/icon-192.png',
