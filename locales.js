...
const translations = {
    he: {
        ...
        missions: {
            ...
            vip_marathonDesc: (t) => `שרת ${t} לקוחות VIP ברצף ללא הפסקה`,
    ...
    en: {
        ...
        missions: {
            ...
            vip_marathonDesc: (t) => `Serve ${t} VIP clients in a row without a break`,
    ...
    es: {
        ...
        missions: {
            ...
            vip_marathonDesc: (t) => `Atiende a ${t} clientes VIP seguidos sin interrupción`,
    ...
    ru: {
        ...
        missions: {
            ...
            vip_marathonDesc: (t) => `Обслужите ${t} VIP-клиентов подряд без перерыва`,
...
Object.assign(translations.es, {
    vipPersonalities: [
        ...
        { name: "Omar Abdullah",       dialog: "El tiempo es dinero. Sean rapidos, por favor." },
        { name: "Chen Wei",            dialog: "Primero los negocios. Los placeres, despues." },
        { name: "Isabella Martinez",   dialog: "Me han dicho que son los mejores. Espero que sea verdad." },
        { name: "Marcus Johnson",      dialog: "Solo trabajo con los mejores. Mas vale que lo demuestren." },
        { name: "Yossi Cohen",         dialog: "Soy cliente desde hace anos. Tratadme como tal." },
        { name: "Natasha Volkova",     dialog: "En Rusia tenia un banquero personal. Que me ofrecen?" },
        { name: "Aaron Levy",          dialog: "Espere mucho tiempo. El dinero no espera." },
        { name: "Sofia Andreescu",     dialog: "Espero discrecion y rapidez. En ese orden." },
        { name: "David Mizrahi",       dialog: "Tengo una reunion en diez minutos. Empezamos?" },
        ...
        { name: "Hiroshi Tanaka",      dialog: "Confio en numeros, no en palabras. Muestrenme resultados." },
